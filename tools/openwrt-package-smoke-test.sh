...
require_grep 'PKG_RELEASE:=21' "$PKG_DIR/Makefile"
require_grep 'PKG_SOURCE_VERSION:=bbcc1bf0d2981d64d90f69b264424d1a7ef18a41' "$PKG_DIR/Makefile"
...
require_grep 'PKG_RELEASE:=21' "$LUCI_DIR/Makefile"
...
require_grep 'package/fakesip/clean' "$ROOT_DIR/tools/build-openwrt-ipk.sh"
require_grep 'package/luci-app-fakesip/clean' "$ROOT_DIR/tools/build-openwrt-ipk.sh"

...
require_grep 'PKG_RELEASE:=14' "$PKG_DIR/Makefile"
require_grep 'PKG_SOURCE_VERSION:=c40b8fbaae3377e3542c402e2c29cc1207ebc425' "$PKG_DIR/Makefile"
...
require_grep 'PKG_RELEASE:=6' "$LUCI_DIR/Makefile"

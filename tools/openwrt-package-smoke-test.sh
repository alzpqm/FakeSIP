...
require_grep 'PKG_RELEASE:=20' "$PKG_DIR/Makefile"
require_grep 'PKG_SOURCE_VERSION:=8f000525b1fa2711a2659810df397ebdcc21d7f7' "$PKG_DIR/Makefile"
...
require_grep 'PKG_RELEASE:=20' "$LUCI_DIR/Makefile"
